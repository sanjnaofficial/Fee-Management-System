...
public final class FragmentHome3Binding implements ViewBinding {
  ...
  private FragmentHome3Binding(@NonNull ConstraintLayout rootView, @NonNull TextView emailTV,
      @NonNull TextView feesPendingTV, @NonNull TextView feesTotalTV,
      ...
      @NonNull LinearLayout ll1, @NonNull TextView nameTV, @NonNull TextView phoneTV,
      @NonNull TextView regTV, @NonNull TextView textView2) {
  ...
  public static FragmentHome3Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_home3, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static FragmentHome3Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentHome3Binding((ConstraintLayout) rootView, emailTV, feesPendingTV,
          feesTotalTV, linearLayout, linearLayout2, linearLayout3, linearLayout4, linearLayout5,
          linearLayout6, ll1, nameTV, phoneTV, regTV, textView2);
    }
